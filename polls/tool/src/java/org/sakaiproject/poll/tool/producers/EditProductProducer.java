...
@Slf4j
public class EditProductProducer implements ViewComponentProducer,NavigationCaseReporter, ViewParamsReporter{
	public static final String VIEW_ID = "editProduct";	
	...
	public void fillComponents(UIContainer tofill, ViewParameters viewparams,
            ...
            UIOutput.make(tofill, "edit-product-title","Edit Product" + product.getName());				
            ...
            UIInput.make(newProductForm, "product-name-input", "#{productBean.productName}", product.getName());
            UIInput.make(newProductForm, "product-price-input", "#{productBean.productPrice}", String.valueOf(product.getPrice()));
            UIInput.make(newProductForm, "product-stock-input", "#{productBean.productStock}", String.valueOf(product.getStock()));
            ...
            UICommand.make(newProductForm, "submit-new-product", "#{productBean.processActionUpdateProduct}");                                                                                                                      
	}        
