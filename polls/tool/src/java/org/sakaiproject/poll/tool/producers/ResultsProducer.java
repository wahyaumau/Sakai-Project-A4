...
public class ResultsProducer implements ViewComponentProducer,NavigationCaseReporter,ViewParamsReporter {
	...
	public static final String VIEW_ID = "voteResults";
        private static final String NAVIGATE_USER_NOT_VOTE_POLL = "actions-user-not-vote-poll";
        private static final String NAVIGATE_OTHER_OPTION_POLL = "actions-other-option-poll";
	...
	public void fillComponents(UIContainer tofill, ViewParameters viewparams,
		...
		UIOutput.make(tofill, "polls-html", null).decorate(new UIFreeAttributeDecorator(langMap));
                ...
                UIInternalLink.make(actions, NAVIGATE_USER_NOT_VOTE_POLL, UIMessage.make("action_user_not_vote"),new PollViewParameters(UserNotVotePollProducer.VIEW_ID, poll.getPollId().toString()));
                UIInternalLink.make(actions, NAVIGATE_OTHER_OPTION_POLL, UIMessage.make("action_other_option_poll"),new PollViewParameters(OtherOptionPollProducer.VIEW_ID, poll.getPollId().toString()));
