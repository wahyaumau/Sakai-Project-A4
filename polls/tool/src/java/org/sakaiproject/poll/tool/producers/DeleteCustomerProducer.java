...
@Slf4j
public class DeleteCustomerProducer implements ViewComponentProducer,NavigationCaseReporter, ViewParamsReporter{
	public static final String VIEW_ID = "deleteCustomer";	
	...
	public void fillComponents(UIContainer tofill, ViewParameters viewparams,
            ...
            UIOutput.make(tofill, "customer-delete-confirm", customer.getName());
            ...
            UICommand.make(newProductTypeForm, "submit-new-customer", "#{customerBean.processActionDeleteCustomer}");
	}        
