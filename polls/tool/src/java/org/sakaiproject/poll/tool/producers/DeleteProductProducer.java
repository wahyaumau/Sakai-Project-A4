...
@Slf4j
public class DeleteProductProducer implements ViewComponentProducer,NavigationCaseReporter, ViewParamsReporter{
	public static final String VIEW_ID = "deleteProduct";	
	...
	public void fillComponents(UIContainer tofill, ViewParameters viewparams,
            ...
            UIOutput.make(tofill, "edit-product-title","Delete Product" + product.getName());            
            UIOutput.make(tofill, "product-name", "Product Name : "+ product.getName());            
            UIOutput.make(tofill, "product-stock","Product Stock : "+ String.valueOf(product.getStock()));            
            UIOutput.make(tofill, "product-price","Product Price" + String.valueOf(product.getPrice()));            
            ...
            UICommand.make(newProductForm, "submit-new-product", "#{productBean.processActionDeleteProduct}");                                                                                                                      
	}        
