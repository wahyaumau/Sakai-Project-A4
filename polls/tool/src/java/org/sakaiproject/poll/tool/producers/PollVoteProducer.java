...
public class PollVoteProducer implements ViewComponentProducer,ViewParamsReporter, ActionResultInterceptor,NavigationCaseReporter {
	...
	public static final String VIEW_ID = "voteQuestion";
        ...
        private static final String NAVIGATE_ADD_OTHER_OPTION = "actions-add-other-option";
	...
	public void fillComponents(UIContainer tofill, ViewParameters viewparams, ComponentChecker checker) {
		...
		UIOutput.make(tofill, "polls-html", null).decorate(new UIFreeAttributeDecorator(langMap));
                ...
                UIInternalLink.make(actions, NAVIGATE_ADD_OTHER_OPTION, UIMessage.make("action_add_other_option"),new PollViewParameters(AddOtherOptionProducer.VIEW_ID, poll.getPollId().toString()));
